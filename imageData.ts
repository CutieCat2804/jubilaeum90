...
export const images: Image[] = [
  ...
  {
    src: "/90Bilder/9_90.jpg",
    caption: [
      "2010 - Projektreise nach Südafrika",
      "Wohl eins der größten Abenteuer in der Geschichte des Stames: die Projektreise ans andere Ende der Welt! \nHier nur ein Projekt von vielen während der Reise. Das Bemalen einer Trennwand in einem Waisenhaus in einem südafrikanischen Townships. Für die Kinder und alle Pfadfinder*innen ein unvergessliches gemeinschaftliches Erlebnis.",
    ],
  },
  {
    src: "/90Bilder/10_90.jpg",
    caption: [
